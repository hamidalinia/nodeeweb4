...
const Form = ({ children, ...rest }) => {
  ...
  function saveForm(values) {
    ...
    API.put("/courseCategory/"+values._id, JSON.stringify({ ...values }))
      .then(({ data = {} }) => {
        ...
        if (data._id) {
          ...
          // window.location.href = "/#/courseCategory/" + data._id;
...
function save(record) {
  ...
  if (theID)
    API.put("/course/modifyPriceByCat/" + theID, JSON.stringify({ type: type, number: number }))
      .then(({ data = {} }) => {
...
export const categoryShow = (props) => {
  ...
  return (
    [<Create {...props}>
      ...
      <ResourceContextProvider value={"course"}>
        <List basePath={"/course/bycat/" + props["id"]} filter={{ id: props["id"], kind: "bycat" }}
