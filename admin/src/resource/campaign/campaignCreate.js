    ...
    return (
        <Create {...props}>
            <SimpleForm>
                ...
                <SelectInput
                    label={translate("resources.campaign.filter")}
                    fullWidth

                    source="filter"
                    choices={[
                        {id: "GetCountOfOnceBought", name: translate("resources.dashboard.GetCountOfOnceBought")},
                        // {id: "GetCountOfActiveUsers", name: translate("resources.dashboard.GetCountOfActiveUsers")},
                        {id: "GetCountOfMoreThanOnceBought", name: translate("resources.dashboard.GetCountOfMoreThanOnceBought")},
                        {id: "GetCountOfNeverBought", name: translate("resources.dashboard.GetCountOfNeverBought")},
                        {id: "GetCountOfExpired", name: translate("resources.dashboard.GetCountOfExpired")},
                    ]}
                />
