...
const Form = ({children, ...props}) => {
    ...
    function save(values) {
        ...
        // return;
        API.post("/request/", JSON.stringify({...values}))
            .then(({data = {}}) => {
                if (data) {
        ...
        <>
            ...
            <SimpleForm {...props}
                ...
                <ControlledTextInput
                    ...
                    label={translate('resources.request.customer')}
                />
                <AddProductsField
                    label={translate('resources.request.products')}
                    handleChange={(t, v) => {
                        handleChange(t, v)
                    }}
                    source="card"
                    ...
                    <div className={'col col-md-6 col-xs-12'}>
                        ...
                        <div className={'box'}>
                            ...
                            <ControlledTextInput
                                ...
                                label={translate('resources.request.sum')}
                            />
                            <ControlledTextInput
                                className={"ltr"}
                                source={'amount'}
