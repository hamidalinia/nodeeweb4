    ...
    <div id={"theprint"} ref={divRef}>
      ...
      <table className="order-data-addresses ">
        ...
        <tr>
          ...
          <td>
            ...
            <div>
              <div>
                <input style={{ width: "100%" }} value={cfirstName} onChange={(e) => changeInput("cfirstName", e)}/>
      ...
      <table className="order-details ">
        ...
        <tr>
          ...
          <th className="quantityinprice">مبلغ </th>
          ...
          if (cpackage[tyhj])
            return (
              <tr className="" key={tyhj}>
                ...
                <td className="product" style={{maxWidth:'140px'}}>
