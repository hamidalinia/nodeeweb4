...
class SidebarActions extends React.PureComponent {
  ...
  render() {
    ...
    let { requireWarranty,t, updatedAt, countryChoosed, type, _id, firstCategory, in_stock, quantity, secondCategory, thirdCategory, title, photos, weight, price, salePrice, options, combinations, method, single = true ,oneItemPerOrder=false,notBuyableAlone=false} = this.props;
      ...
      [<div key={0}>
        ...
        <Col lg={12} md={12} sm={12} xs={12} className="mb-3 mt-3">
          ...
          <AddToCardButton item={{
            ...
            weight: weight,
            price: price,
            notBuyableAlone: notBuyableAlone,
