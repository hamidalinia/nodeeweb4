...
//                 return;
                            ...
                            req.httpRequest(theReq).then(function (parsedBody) {
                                ...
                                let obj = {
                                    ...
                                    "Authority": parsedBody["data"]["trackId"] || parsedBody["data"]["Authority"] || parsedBody["data"]["token"]
                                };
                                ...
                                function createTransaction(){
                                    Transaction.create(obj, function (err, transaction) {
                                        ...
                                        Order.findByIdAndUpdate(req.params._id, {
                                            ...
                                            if (parsedBody['data'] && parsedBody['data']['method']=='tara') {
                                                return res.json({
                                                    success: true,
                                                    token: parsedBody['data']['token'],
                                                    method: parsedBody['data']['method'],
                                                    theUrl: parsedBody['data']['theUrl'],
